...
Library(c("kableExtra", "devtools", "tidyverse", "akima", "spatial", "gstat", "automap", "spatstat", "rgdal", "raster"))
# Package sur GitHub
...
La diversité est calculée avec le package _SpatDiv_ disponible sur GitHub, à installer.
...
suppressWarnings(geoXprd <- predict(geoX, newdata=France))
# Carte finale
spplot(geoXprd, "var1.pred")
```

Remarque : le fond de carte `France` du package **raster** utilise un système de projection qui génère des avertissements par `predict()` en raison de l'évoluton du package **rgdal**[^3].
